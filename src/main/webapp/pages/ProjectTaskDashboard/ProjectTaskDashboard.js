Application.$controller("ProjectTaskDashboardPageController", ["$scope", function($scope) {
    ...
    $scope.projectscountuserbyproductonSuccess = function(variable, data, options) {
        //console.log(data);
        $scope.Widgets.projectqtylbl1.caption = data.content[0].firstname + " " + data.content[0].lastname;
        $scope.Widgets.projectqtylbl11.caption = data.content[0].totprojects;
        $scope.Widgets.projectqtylbl2.caption = data.content[1].firstname + " " + data.content[1].lastname;
        $scope.Widgets.projectqtylbl22.caption = data.content[1].totprojects;
        $scope.Widgets.projectqtylbl3.caption = data.content[2].firstname + " " + data.content[2].lastname;
        $scope.Widgets.projectqtylbl33.caption = data.content[2].totprojects;
        $scope.Widgets.projectqtylbl4.caption = data.content[3].firstname + " " + data.content[3].lastname;
        $scope.Widgets.projectqtylbl44.caption = data.content[3].totprojects;
        $scope.Widgets.projectqtylbl5.caption = data.content[4].firstname + " " + data.content[4].lastname;
        $scope.Widgets.projectqtylbl55.caption = data.content[4].totprojects;
        $scope.Widgets.projectqtylbl6.caption = data.content[5].firstname + " " + data.content[5].lastname;
...
Application.$controller("table4Controller", ["$scope",
    function($scope) {
        "use strict";
        $scope.ctrlScope = $scope;
    }
