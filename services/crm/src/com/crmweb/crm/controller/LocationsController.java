...
import com.crmweb.crm.service.LocationsService;
...
public class LocationsController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Locations getLocations(@PathVariable("id") Integer id) {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Locations editLocations(@PathVariable("id") Integer id, @RequestBody Locations locations) {
        LOGGER.debug("Editing Locations with id: {}" , locations.getId());
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public boolean deleteLocations(@PathVariable("id") Integer id) {
    ...
    public Page<Posts> findAssociatedPostses(@PathVariable("id") Integer id, Pageable pageable) {
        ...
        return locationsService.findAssociatedPostses(id, pageable);
    }
