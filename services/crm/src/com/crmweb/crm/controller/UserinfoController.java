...
import com.crmweb.crm.service.UserinfoService;
 ...
 * @see Userinfo
 */
@RestController("crm.UserinfoController")
...
public class UserinfoController {
	...
	@ApiOperation(value = "Returns the total count of Userinfo instances matching the optional query (q) request param. If query string is too big to fit in GET request's query param, use POST method with application/x-www-form-urlencoded format.")
